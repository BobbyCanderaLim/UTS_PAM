...
public class PopularMovieModel implements Parcelable
{
    ...
    public final static Parcelable.Creator<PopularMovieModel> CREATOR = new Creator<PopularMovieModel>() {
    ...
    protected PopularMovieModel(Parcel in) {
        ...
        in.readList(this.genreIds, (java.lang.String.class.getClassLoader()));
    ...
    public void setVoteAverage(String voteAverage) {
        this.voteAverage = Float.parseFloat(voteAverage);
    }
